...
- To avoid that, add a **Railway Volume** and mount it at the project's
  `session/` directory (Project Settings → Volumes), or move the session
  storage to an external store (S3, a database, etc.) if you want to
  customize further.
